...
Source0:	http://ftp.gnome.org/pub/gnome/sources/nautilus/2.32/nautilus-%{version}.tar.bz2
# Source0-md5:	f75f387d1b439079967581d876009426
URL:		http://nautilus.eazel.com/
Patch0:		%{name}-freddix.patch
Patch1:		%{name}-disable-deprecated.patch
...
%define		_libexecdir	%{_libdir}/nautilus
